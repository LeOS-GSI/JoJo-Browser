...
repackage_msix="$SOURCE/mach repackage msix --input $PACKAGE --channel unofficial --arch $(msix_arch $ARCH) --publisher CN=846D51B2-15A2-4033-86D1-071B877C86A7 --identity-name 31856maltejur.LibreWolf --publisher-display-name LibreWolf"
